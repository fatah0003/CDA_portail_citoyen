 ...
 */
class getVichUploader_Listener_Upload_PropositionFilesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.proposition_files' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.proposition_files'])) {
            return $container->privates['vich_uploader.listener.upload.proposition_files'];
        }

        return $container->privates['vich_uploader.listener.upload.proposition_files'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('proposition_files', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
