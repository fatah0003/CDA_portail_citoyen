 ...
 */
class getVichUploader_Listener_Remove_PropositionFilesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.proposition_files' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.proposition_files'])) {
            return $container->privates['vich_uploader.listener.remove.proposition_files'];
        }

        return $container->privates['vich_uploader.listener.remove.proposition_files'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('proposition_files', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
