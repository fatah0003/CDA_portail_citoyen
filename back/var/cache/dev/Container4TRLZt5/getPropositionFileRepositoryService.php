 ...
 */
class getPropositionFileRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PropositionFileRepository' shared autowired service.
     *
     * @return \App\Repository\PropositionFileRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PropositionFileRepository.php';

        return $container->privates['App\\Repository\\PropositionFileRepository'] = new \App\Repository\PropositionFileRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
