    ...
    <div class=\"proposition-info\">
        ...
        yield "\">
                <button class=\"btn-primary-amz\">
                    ";
        // line 52
        if ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 52, $this->source); })()), "user", [], "any", false, false, false, 52) && CoreExtension::getAttribute($this->env, $this->source, (isset($context["proposition"]) || array_key_exists("proposition", $context) ? $context["proposition"] : (function () { throw new RuntimeError('Variable "proposition" does not exist.', 52, $this->source); })()), "isFavoritedBy", [CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 52, $this->source); })()), "user", [], "any", false, false, false, 52)], "method", false, false, false, 52))) {
            // line 53
            yield "                        Retirer de vos favoris ❤️
                    ";
        } else {
            // line 55
        ...
        yield "                </button>
                ...
                <span class=\"ms-2\">❤️ ";
        // line 59
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["proposition"]) || array_key_exists("proposition", $context) ? $context["proposition"] : (function () { throw new RuntimeError('Variable "proposition" does not exist.', 59, $this->source); })()), "getFavoritesCount", [], "method", false, false, false, 59), "html", null, true);
        yield "</span>
            </form>

            <a href=\"";
        // line 62
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_proposition_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["proposition"]) || array_key_exists("proposition", $context) ? $context["proposition"] : (function () { throw new RuntimeError('Variable "proposition" does not exist.', 62, $this->source); })()), "id", [], "any", false, false, false, 62)]), "html", null, true);
...
";
    ...
    {
        return array (  279 => 65,  274 => 63,  270 => 62,  264 => 59,  260 => 57,  256 => 55,  252 => 53,  250 => 52,  245 => 50,  241 => 49,  233 => 44,  228 => 41,  221 => 39,  208 => 38,  202 => 37,  184 => 36,  179 => 34,  175 => 33,  171 => 32,  165 => 29,  161 => 28,  155 => 24,  148 => 22,  143 => 21,  140 => 20,  134 => 17,  129 => 16,  124 => 14,  119 => 13,  116 => 12,  113 => 11,  110 => 10,  105 => 9,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}
", "proposition/show.html.twig", "C:\\Users\\Daniel\\Desktop\\tp_portail\\CDA_portail_citoyen\\back\\templates\\proposition\\show.html.twig");
    }
}
