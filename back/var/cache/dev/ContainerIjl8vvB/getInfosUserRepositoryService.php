 ...
 */
class getInfosUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InfosUserRepository' shared autowired service.
     *
     * @return \App\Repository\InfosUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InfosUserRepository.php';

        return $container->privates['App\\Repository\\InfosUserRepository'] = new \App\Repository\InfosUserRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
